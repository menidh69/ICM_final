...
public class constantes {
    ...
    public static final String crear_tabla_citas = "CREATE TABLE citas (id INTEGER PRIMARY KEY, nombre varchar(20) NOT NULL, servicio varchar(20), precio FLOAT(15,2), fecha varchar(20), hora varchar(20), finalizado BOOLEAN DEFAULT 'false' )";
}
